...
import  bgImg1  from '../../../assets/home/banner-2.jpg';
const Hero1 = () => {
    return (
        <div className='min-h-screen bg-cover bg-center bg-no-repeat' style={{backgroundImage: `url(${bgImg1})`}}>
        <div className="min-h-screen flex items-center justify-start pl-10 text-white bg-black bg-opacity-60">
             <div className="space-y-4">
                ...
                <h1 className='md:text-5xl text-4xl font-bold '>Course from Home</h1>
